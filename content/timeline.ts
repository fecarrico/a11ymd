...
export const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: {
      "pt-BR":
        "Painel sobre acessibilidade e inclusão dentro da Natura, ao lado de Simone Freire, fundadora do movimento Web para Todos, e de Vitor David, do CB-040 da ABNT e autor da frase que abre este site. O tema saindo do círculo de especialistas e entrando nas decisões e na cultura das organizações — exatamente a aposta deste projeto.",
      en: "An accessibility and inclusion panel inside Natura, alongside Simone Freire, founder of the Web para Todos movement, and Vitor David, of ABNT’s CB-040 committee and author of the sentence that opens this site. The subject stepping out of the specialists' circle and into organizational decisions and culture — precisely this project's bet.",
    },
    link: {
