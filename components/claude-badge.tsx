  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 200" className="h-full w-full">
        ...
        {/* O starburst, centrado — estático. Sem o anel de texto (usos
            pequenos, como a timeline), ele escala para preencher a caixa;
            com o anel, mantém o tamanho original que deixa espaço à órbita. */}
        <g transform={phrase ? "translate(50 50)" : "translate(6 6) scale(1.918)"}>
          <path
            fill="#D97757"
